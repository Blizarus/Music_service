...
4: { lineDashStyle: [4, 2, 3, 2] } 
        ...
        function drawAmountChart() {
            var data = new google.visualization.DataTable();
            data.addColumn('string', 'Месяц');
            data.addColumn('number', 'Прослушивания для исполнителя "The Beatles"');
            data.addColumn('number', 'l=3');
data.addColumn('number', 'l=5');
data.addColumn('number', 'l=7');
data.addRows([
...
?>
            ...
            var options = {
                title: 'Прослушивания для исполнителя "The Beatles" по месяцам',
                curveType: 'function',
                legend: { position: 'bottom' },
                series: {
1: { lineDashStyle: [14, 2, 7, 2] }, // Для линии скользящего среднего
...
3: { lineDashStyle: [14, 2, 7, 2] } // Для линии скользящего среднего
        ...
        function drawAmountChart4() {
            var data = new google.visualization.DataTable();
            data.addColumn('string', 'Месяц');
            data.addColumn('number', 'Прослушивания для исполнителя "The Beatles" yt');
            data.addColumn('number', 'Линейный тренд');
data.addColumn('number', 'Параболический тренд');
data.addColumn('number', 'Показательный тренд');
data.addRows([
...
?>
            ...
            var options = {
                title: 'Фактические и расчетные уровни ряда динамики прослушиваний для исполнителя "The Beatles"',
                curveType: 'function',
                legend: { position: 'bottom' },
                trendlines: {
      0: {
...
?>
            ...
            var options = {
                title: 'Фактические и расчетные уровни ряда динамики прослушиваний для жанра "Хип-Хоп"',
                curveType: 'function',
                legend: { position: 'bottom' },
                trendlines: {
      0: {
