    ...
    <div class="container">
      ...
      <section class="content-news">
        <article class="news-block">
          ...
          <a href="search_music.php?criteria=news1" class="news-block-news_link"><img src="/media/image/link.svg" alt="ИконкаПерехода"></a>
        </article>
        <article class="news-block">
          ...
          <a href="search_music.php?criteria=news2" class="news-block-news_link"><img src="/media/image/link.svg" alt="ИконкаПерехода"></a>
        </article>
        <?php 
